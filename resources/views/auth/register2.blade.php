			...
			<div class="container">
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2">
					<div class="col mx-auto">
                      ...
                      @csrf
											<div class="col-sm-6">
												<label for="inputFirstName" class="form-label">Applicant Name</label>
                      ...
                      <div class="col-12">
                        ...
                        <input type="number" id="phone" name="phone" class="form-control"
                               placeholder="Enter Email" required/>
											...
											<div class="col-12">
												<label for="inputSelectCountry" class="form-label">Choose Country</label>
                      ...
                      <div class="col-12">
                        <label for="inputSelectCountry" class="form-label">Select Gender</label>
