...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
     ...
     <marquee style="color:green; font-size:20px;" behavior="scroll" direction="left">Important Notice: Profit Share & Club Bonus of this week will be given on 07-04-2022 || Buy Unit 1$ and earn Smart income</marquee>
    <!--end breadcrumb-->
