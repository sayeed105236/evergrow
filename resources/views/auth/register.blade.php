<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="name" value="{{ __('Mobile Number') }}" />
            ...
            <div class="mt-4">
                <x-jet-label for="name" value="{{ __('Sponsor') }}" />
                <select class="form-select" name="sponsor" id="sponsor" aria-label="Default select example">
            ...
            <div class="mt-4">
                <x-jet-label for="name" value="{{ __('Position') }}" />
